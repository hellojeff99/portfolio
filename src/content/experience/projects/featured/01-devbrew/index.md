...
![live-chat](./live-chat.gif)

## 구현 화면

| 멘토 탐색             | 커피챗 예약           | 커피챗 승인                    | 실시간 채팅     |
| --------------------- | --------------------- | ------------------------------ | --------------- |
| ![](./find-mento.png) | ![](./metno-info.png) | ![](./dashboard-for-mento.png) | ![](./chat.png) |
...
![](./image-20260721145558311.png)

---

## 시스템 아키텍처

![](./image-20260721145617162.png)
